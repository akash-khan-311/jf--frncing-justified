...
export default function Footer() {
  return (
    <footer>
      <div className="bg-[#0c2d57] text-white py-10 px-6 md:px-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 bg-[#0c2d57] ">
      ...
      <div>
        <div className="container mx-auto flex justify-between items-center py-4">
          <p className="text-xl">© 2023 JF Fencing. All rights reserved.</p>
